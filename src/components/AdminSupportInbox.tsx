...
export default function AdminSupportInbox() {
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(() => loadThreads().catch(requestError => setError(requestError.message)), 4000);
